    ...
    <div className="card max-w-96 bg-base-100 shadow-xl rounded-t-none">
      ...
      <div className="card-body items-center text-center bg-[#F3F3F3]">
        ...
        <div className="card-actions">
          <button className="px-4 py-3 rounded-md uppercase text-xl text-[#BB8506] border-b-2 border-[#BB8506] bg-[#E8E8E8] hover:bg-[#1F2937] hover:border-[#1F2937] duration-500">
            add to cart
          </button>
        </div>
      </div>
